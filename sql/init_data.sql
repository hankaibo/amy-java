...
/*!40000 ALTER TABLE `sys_information` DISABLE KEYS */;
INSERT INTO `sys_information` (`id`, `avatar`, `title`, `content`, `type`, `status`, `is_read`, `is_publish`, `publish_time`, `create_time`, `update_time`) VALUES
	(9, NULL, '123', '123', 2, NULL, NULL, NULL, NULL, '2019-10-29 15:17:41', NULL),
	(10, NULL, '33333', '12323', 3, NULL, NULL, NULL, NULL, '2019-10-29 15:17:57', NULL);
/*!40000 ALTER TABLE `sys_information` ENABLE KEYS */;
...
INSERT INTO `sys_resource` (`id`, `parent_id`, `name`, `lft`, `rgt`, `level`, `code`, `status`, `is_update`, `uri`, `type`, `method`, `icon`, `description`, `create_time`, `update_time`) VALUES
	...
	(66, 62, '批量删除信息', 128, 129, 4, 'system:information:batchDelete', 1, 1, '/api/v1/information', 2, 'DELETE', NULL, NULL, '2020-03-29 11:13:27', '2020-04-01 15:42:57'),
	(67, 62, '获取信息详情', 130, 131, 4, 'system:information:detail', 1, 1, '/api/v1/information/*', 2, 'GET', NULL, NULL, '2020-03-29 11:18:23', '2020-04-01 15:42:57'),
	(68, 62, '更新信息', 132, 133, 4, 'system:information:update', 1, 1, '/api/v1/information/*', 2, 'PUT', NULL, NULL, '2020-03-29 11:19:04', '2020-04-01 15:42:57'),
	(69, 62, '删除信息', 134, 135, 4, 'system:information:delete', 1, 1, '/api/v1/information/*', 2, 'DELETE', NULL, NULL, '2020-03-29 11:19:41', '2020-04-01 15:42:57'),
	(70, 62, '发布信息', 136, 137, 4, 'system:information:publish', 1, 1, '/api/v1/information/*/publish', 2, 'PATCH', NULL, NULL, '2020-03-29 11:20:39', '2020-04-01 15:42:57'),
	(71, 62, '启用禁用信息', 138, 139, 4, 'system:information:status', 1, 1, '/api/v1/information/*/status', 2, 'PATCH', NULL, NULL, '2020-03-29 11:21:37', '2020-04-01 15:42:57'),
	(72, 62, '定时发布信息', 140, 141, 4, 'system:information:timer', 1, 1, '/api/v1/information/timer', 2, 'POST', NULL, NULL, '2020-03-30 03:29:19', '2020-04-01 15:42:57');
...
INSERT INTO `sys_user` (`id`, `username`, `nickname`, `real_name`, `password`, `salt`, `status`, `avatar`, `email`, `phone`, `mobile`, `sex`, `last_login_time`, `create_time`, `update_time`) VALUES
	(1, 'admin', '管理员', NULL, '$2a$10$BQNgm4HovoDft9kj93gSgOnV0PNjDwSEEqTTt81Ghd5sgH1zAs5kO', '$2a$10$BQNgm4HovoDft9kj93gSgO', 1, 'http://lorempixel.com/200/200/', NULL, NULL, NULL, NULL, NULL, '2019-10-06 08:43:06', '2020-04-01 11:28:42'),
	(27, 'test', NULL, NULL, '$2a$10$XScz.FTdh22uSGMnBrjiLutcKA7tlnuH2RhM9SE9lzUfauv8HC/k6', '$2a$10$XScz.FTdh22uSGMnBrjiLu', 0, NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-30 03:36:43', '2020-04-01 12:16:03'),
	(28, 'user', NULL, NULL, '$2a$10$4hC69dCJgAIlZIPYVgSyj.PqMa8qOJ7EgJYlpRsq2GjhS/KHq8si.', '$2a$10$4hC69dCJgAIlZIPYVgSyj.', 1, NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-31 11:18:39', '2020-04-01 13:29:52');
