...
(
  ...
  AUTO_INCREMENT = 2
  DEFAULT CHARSET = utf8 COMMENT ='系统站内信表。';
...
/*!40000 ALTER TABLE `sys_message`
    DISABLE KEYS */;
INSERT INTO `sys_message` (`id`, `send_id`, `receive_id`, `content_id`, `status`, `is_publish`, `publish_time`,
                           `is_read`, `create_time`, `update_time`)
VALUES (1, 1, 1, 11, 1, 1, NULL, 0, '2020-06-10 16:08:53', NULL);
/*!40000 ALTER TABLE `sys_message`
    ENABLE KEYS */;
...
VALUES (1, NULL, '菜单', 1, 144, 1, 'menuTree', 1, 1, NULL, 1, NULL, NULL, NULL, '2019-10-07 01:30:52',
       ...
       (65, 62, '批量发布信息', 126, 127, 4, 'system:message:batchPublish', 1, 1, '/api/v1/message', 2, 'PUT', NULL, NULL,
        '2020-03-29 11:12:49', '2020-04-01 15:42:57'),
       (66, 62, '批量删除信息', 128, 129, 4, 'system:message:batchDelete', 1, 1, '/api/v1/message', 2, 'DELETE', NULL, NULL,
        '2020-03-29 11:13:27', '2020-04-01 15:42:57'),
       ...
       (69, 62, '删除信息', 134, 135, 4, 'system:message:delete', 1, 1, '/api/v1/message/*', 2, 'DELETE', NULL, NULL,
        '2020-03-29 11:19:41', '2020-04-01 15:42:57'),
       (70, 62, '发布信息', 136, 137, 4, 'system:message:publish', 1, 1, '/api/v1/message/*/publish', 2, 'PATCH', NULL,
        NULL, '2020-03-29 11:20:39', '2020-04-01 15:42:57'),
       (71, 62, '启用禁用信息', 138, 139, 4, 'system:message:status', 1, 1, '/api/v1/message/*/status', 2, 'PATCH', NULL,
        NULL, '2020-03-29 11:21:37', '2020-04-01 15:42:57'),
       (72, 62, '定时发布信息', 140, 141, 4, 'system:message:timer', 1, 1, '/api/v1/message/timer', 2, 'POST', NULL, NULL,
        '2020-03-30 03:29:19', '2020-04-01 15:42:57');
/*!40000 ALTER TABLE `sys_resource`
    ENABLE KEYS */;
...
VALUES (1, 'admin', '管理员', 'hankaibo', '$2a$10$BQNgm4HovoDft9kj93gSgOnV0PNjDwSEEqTTt81Ghd5sgH1zAs5kO',
        '$2a$10$BQNgm4HovoDft9kj93gSgO', 1, 'E:/tmp/upload/images/d5034ec5-4938-4d68-98cf-9e8058f164e6.jpeg',
        'hankaibo@mail.com', '+86-12345678', '+86-18612345678', NULL, '我是一条狗。', '胸无点墨，满腹牢骚', '丰台区翠林小区三里13号楼', NULL,
        '2019-10-03 00:43:06', '2020-08-14 02:27:50'),
