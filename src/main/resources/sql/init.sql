...
INSERT INTO `sys_resource` (`id`, `parent_id`, `name`, `lft`, `rgt`, `level`, `code`, `status`, `is_update`, `uri`, `type`, `method`, `icon`, `description`, `create_time`, `update_time`) VALUES
	(1, NULL, '菜单', 1, 148, 1, 'menuTree', 1, 1, NULL, 1, NULL, NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:59'),
	...
	(4, 1, '系统配置', 32, 147, 2, 'system', 1, 1, NULL, 1, NULL, NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:59'),
	(5, 4, '部门管理', 33, 50, 3, 'system:department', 1, 1, NULL, 1, NULL, NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(6, 5, '获取部门树', 34, 35, 4, 'system:department:tree', 1, 1, '/api/v1/departments', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(7, 5, '新建部门', 36, 37, 4, 'system:department:add', 1, 1, '/api/v1/departments', 2, 'POST', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(8, 5, '移动部门', 38, 39, 4, 'system:department:move', 1, 1, '/api/v1/departments', 2, 'PUT', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(9, 5, '获取部门详情', 40, 41, 4, 'system:department:detail', 1, 1, '/api/v1/departments/*', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(10, 5, '更新部门', 42, 43, 4, 'system:department:update', 1, 1, '/api/v1/departments/*', 2, 'PUT', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(11, 5, '删除部门', 44, 45, 4, 'system:department:delete', 1, 1, '/api/v1/departments/*', 2, 'DELETE', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(12, 5, '获取子部门列表', 46, 47, 4, 'system:department:children', 1, 1, '/api/v1/departments/*/children', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(13, 5, '启用禁用部门', 48, 49, 4, 'system:department:status', 1, 1, '/api/v1/departments/*/status', 2, 'PATCH', NULL, NULL, '2019-10-18 10:23:10', '2020-08-28 00:10:50'),
	(14, 4, '用户管理', 51, 74, 3, 'system:user', 1, 1, NULL, 1, NULL, NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(15, 14, '获取用户列表', 52, 53, 4, 'system:user:list', 1, 1, '/api/v1/users', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(16, 14, '新建用户', 54, 55, 4, 'system:user:add', 1, 1, '/api/v1/users', 2, 'POST', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(17, 14, '批量删除用户', 56, 57, 4, 'system:user:batchDelete', 1, 1, '/api/v1/users', 2, 'DELETE', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(18, 14, '获取用户详情', 58, 59, 4, 'system:user:detail', 1, 1, '/api/v1/users/*', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(19, 14, '更新用户', 60, 61, 4, 'system:user:update', 1, 1, '/api/v1/users/*', 2, 'PUT', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(20, 14, '删除用户', 62, 63, 4, 'system:user:delete', 1, 1, '/api/v1/users/*', 2, 'DELETE', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(21, 14, '重置用户密码', 64, 65, 4, 'system:user:pwd:reset', 1, 1, '/api/v1/users/*/password', 2, 'PATCH', NULL, NULL, '2020-03-29 10:27:40', '2020-08-28 00:10:50'),
	(22, 14, '修改用户密码', 66, 67, 4, 'system:user:pwd:update', 1, 1, '/api/v1/users/*/pwd', 2, 'PATCH', NULL, NULL, '2020-03-29 10:28:39', '2020-08-28 00:10:50'),
	(23, 14, '获取用户角色', 68, 69, 4, 'system:user:roles', 1, 1, '/api/v1/users/*/roles', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(24, 14, '赋予用户角色', 70, 71, 4, 'system:user:grant', 1, 1, '/api/v1/users/*/roles', 2, 'POST', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(25, 14, '启用禁用用户', 72, 73, 4, 'system:user:status', 1, 1, '/api/v1/users/*/status', 2, 'PATCH', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(26, 4, '角色管理', 75, 96, 3, 'system:role', 1, 1, NULL, 1, NULL, NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(27, 26, '获取角色树', 76, 77, 4, 'system:role:tree', 1, 1, '/api/v1/roles', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(28, 26, '新建角色', 78, 79, 4, 'system:role:add', 1, 1, '/api/v1/roles', 2, 'POST', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(29, 26, '移动角色', 80, 81, 4, 'system:role:move', 1, 1, '/api/v1/roles', 2, 'PUT', NULL, NULL, '2020-03-29 10:37:33', '2020-08-28 00:10:50'),
	(30, 26, '获取角色详情', 82, 83, 4, 'system:role:detail', 1, 1, '/api/v1/roles/*', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(31, 26, '更新角色', 84, 85, 4, 'system:role:update', 1, 1, '/api/v1/roles/*', 2, 'PUT', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(32, 26, '删除角色', 86, 87, 4, 'system:role:delete', 1, 1, '/api/v1/roles/*', 2, 'DELETE', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(33, 26, '获取子角色列表', 88, 89, 4, 'system:role:children', 1, 1, '/api/v1/roles/*/children', 2, 'GET', NULL, NULL, '2020-03-29 10:40:24', '2020-08-28 00:10:50'),
	(34, 26, '获取角色资源', 90, 91, 4, 'system:role:resources', 1, 1, '/api/v1/roles/*/resources', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(35, 26, '赋予角色资源', 92, 93, 4, 'system:role:grant', 1, 1, '/api/v1/roles/*/resources', 2, 'POST', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(36, 26, '启用禁用角色', 94, 95, 4, 'system:role:status', 1, 1, '/api/v1/roles/*/status', 2, 'PATCH', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(37, 4, '菜单管理', 97, 114, 3, 'system:menu', 1, 1, NULL, 1, NULL, NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(38, 37, '获取菜单树', 98, 99, 4, 'system:menu:tree', 1, 1, '/api/v1/resources', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(39, 37, '新建菜单', 100, 101, 4, 'system:menu:add', 1, 1, '/api/v1/resources', 2, 'POST', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(40, 37, '菜单移动', 102, 103, 4, 'system:menu:move', 1, 1, '/api/v1/resources', 2, 'PUT', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(41, 37, '获取菜单详情', 104, 105, 4, 'system:menu:detail', 1, 1, '/api/v1/resources/*', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(42, 37, '更新菜单', 106, 107, 4, 'system:menu:update', 1, 1, '/api/v1/resources/*', 2, 'PUT', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(43, 37, '删除菜单', 108, 109, 4, 'system:menu:delete', 1, 1, '/api/v1/resources/*', 2, 'DELETE', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(44, 37, '获取子菜单列表', 110, 111, 4, 'system:menu:children', 1, 1, '/api/v1/resources/*/children', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(45, 37, '启用禁用菜单', 112, 113, 4, 'system:menu:status', 1, 1, '/api/v1/resources/*/status', 2, 'PATCH', NULL, NULL, '2019-10-18 10:30:58', '2020-08-28 00:10:50'),
	(46, 4, '接口保护', 115, 130, 3, 'system:api', 1, 1, NULL, 1, NULL, NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(47, 46, '新建接口', 116, 117, 4, 'system:api:add', 1, 1, '/api/v1/resources', 2, 'POST', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(48, 46, '移动接口', 118, 119, 4, 'system:api:move', 1, 1, '/api/v1/resources', 2, 'PUT', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(49, 46, '获取接口详情', 120, 121, 4, 'system:api:detail', 1, 1, '/api/v1/resources/*', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(50, 46, '更新接口', 122, 123, 4, 'system:api:update', 1, 1, '/api/v1/resources/*', 2, 'PUT', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(51, 46, '删除接口', 124, 125, 4, 'system:api:delete', 1, 1, '/api/v1/resources/*', 2, 'DELETE', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(52, 46, '获取子接口列表', 126, 127, 4, 'system:api:children', 1, 1, '/api/v1/resources/*/children', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(53, 46, '启用禁用接口', 128, 129, 4, 'system:api:status', 1, 1, '/api/v1/resources/*/status', 2, 'PATCH', NULL, NULL, '2019-10-18 10:33:12', '2020-08-28 00:10:50'),
	(54, 4, '字典管理', 131, 146, 3, 'system:dictionary', 1, 1, NULL, 1, NULL, NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(55, 54, '获取字典列表', 132, 133, 4, 'system:dictionary:list', 1, 1, '/api/v1/dictionaries', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(56, 54, '新建字典', 134, 135, 4, 'system:dictionary:add', 1, 1, '/api/v1/dictionaries', 2, 'POST', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(57, 54, '批量删除字典', 136, 137, 4, 'system:dictionary:batchDelete', 1, 1, '/api/v1/dictionaries', 2, 'DELETE', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(58, 54, '获取字典详情', 138, 139, 4, 'system:dictionary:detail', 1, 1, '/api/v1/dictionaries/*', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(59, 54, '更新字典', 140, 141, 4, 'system:dictionary:update', 1, 1, '/api/v1/dictionaries/*', 2, 'PUT', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(60, 54, '删除字典', 142, 143, 4, 'system:dictionary:delete', 1, 1, '/api/v1/dictionaries/*', 2, 'DELETE', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(61, 54, '启用禁用字典', 144, 145, 4, 'system:dictionary:status', 1, 1, '/api/v1/dictionaries/*/status', 2, 'PUT', NULL, NULL, '2019-10-07 01:30:52', '2020-08-28 00:10:50'),
	(63, 76, '获取信息列表', 8, 9, 4, 'system:message:list', 1, 1, '/api/v1/messages', 2, 'GET', NULL, NULL, '2020-03-29 11:09:36', '2020-08-27 16:08:49'),
	(64, 76, '新建信息', 10, 11, 4, 'system:message:add', 1, 1, '/api/v1/messages', 2, 'POST', NULL, NULL, '2020-03-29 11:10:31', '2020-08-27 16:09:03'),
	(65, 76, '批量发布信息', 26, 27, 4, 'system:message:batchPublish', 1, 1, '/api/v1/messages', 2, 'PUT', NULL, NULL, '2020-03-29 11:12:49', '2020-08-27 16:10:50'),
	(66, 76, '批量删除信息', 14, 15, 4, 'system:message:batchDelete', 1, 1, '/api/v1/messages', 2, 'DELETE', NULL, NULL, '2020-03-29 11:13:27', '2020-08-27 16:09:36'),
	(67, 76, '获取信息详情', 12, 13, 4, 'system:message:detail', 1, 1, '/api/v1/messages/*', 2, 'GET', NULL, NULL, '2020-03-29 11:18:23', '2020-08-27 16:09:20'),
	(68, 76, '更新信息', 16, 17, 4, 'system:message:update', 1, 1, '/api/v1/messages/*', 2, 'PUT', NULL, NULL, '2020-03-29 11:19:04', '2020-08-27 16:09:49'),
	(69, 76, '删除信息', 18, 19, 4, 'system:message:delete', 1, 1, '/api/v1/messages/*', 2, 'DELETE', NULL, NULL, '2020-03-29 11:19:41', '2020-08-27 16:10:00'),
	(70, 76, '发布信息', 20, 21, 4, 'system:message:publish', 1, 1, '/api/v1/messages/*/publish', 2, 'PATCH', NULL, NULL, '2020-03-29 11:20:39', '2020-08-27 16:10:15'),
	(71, 76, '启用禁用信息', 22, 23, 4, 'system:message:status', 1, 1, '/api/v1/messages/*/status', 2, 'PATCH', NULL, NULL, '2020-03-29 11:21:37', '2020-08-27 16:10:24'),
	(72, 76, '定时发布信息', 24, 25, 4, 'system:message:timer', 1, 1, '/api/v1/messages/timer', 2, 'POST', NULL, NULL, '2020-03-30 03:29:19', '2020-08-27 16:10:34'),
	(73, 1, '个人页', 6, 31, 2, 'account', 1, 1, NULL, 1, NULL, NULL, NULL, '2020-08-27 15:55:07', '2020-08-28 00:10:50'),
	(76, 73, '个人中心', 7, 28, 3, 'account:center', 1, 1, NULL, 1, NULL, NULL, NULL, '2020-08-27 16:05:34', '2020-08-28 00:10:50'),
	(77, 73, '个人设置', 29, 30, 3, 'account:setting', 1, 1, NULL, 1, NULL, NULL, NULL, '2020-08-27 16:05:50', '2020-08-28 00:10:50');
...
CREATE TABLE IF NOT EXISTS `sys_role_resource` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=826 DEFAULT CHARSET=utf8 COMMENT='系统角色权限表。';
