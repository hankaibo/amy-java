...
-- 正在导出表  my_database.sys_dictionary 的数据：~3 rows (大约)
...
-- 正在导出表  my_database.sys_message 的数据：~1 rows (大约)
DELETE FROM `sys_message`;
/*!40000 ALTER TABLE `sys_message` DISABLE KEYS */;
INSERT INTO `sys_message` (`id`, `send_id`, `receive_id`, `content_id`, `status`, `is_publish`, `publish_time`, `is_read`, `create_time`, `update_time`) VALUES
	(1, 1, 1, 11, 1, 1, NULL, 0, '2020-06-10 16:08:53', NULL);
...
INSERT INTO `sys_resource` (`id`, `parent_id`, `name`, `lft`, `rgt`, `level`, `code`, `status`, `is_update`, `uri`, `type`, `method`, `icon`, `description`, `create_time`, `update_time`) VALUES
	(1, NULL, '菜单', 1, 144, 1, 'menuTree', 1, 1, NULL, 1, NULL, NULL, NULL, '2019-10-07 01:30:52', '2020-03-30 03:29:19'),
	...
	(4, 1, '系统配置', 6, 143, 2, 'system', 1, 1, NULL, 1, NULL, NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(5, 4, '部门管理', 7, 24, 3, 'system:department', 1, 1, NULL, 1, NULL, NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(6, 5, '获取部门树', 8, 9, 4, 'system:department:tree', 1, 1, '/api/v1/departments', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(7, 5, '新建部门', 10, 11, 4, 'system:department:add', 1, 1, '/api/v1/departments', 2, 'POST', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(8, 5, '移动部门', 12, 13, 4, 'system:department:move', 1, 1, '/api/v1/departments', 2, 'PUT', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(9, 5, '获取部门详情', 14, 15, 4, 'system:department:detail', 1, 1, '/api/v1/departments/*', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(10, 5, '更新部门', 16, 17, 4, 'system:department:update', 1, 1, '/api/v1/departments/*', 2, 'PUT', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(11, 5, '删除部门', 18, 19, 4, 'system:department:delete', 1, 1, '/api/v1/departments/*', 2, 'DELETE', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(12, 5, '获取子部门列表', 20, 21, 4, 'system:department:children', 1, 1, '/api/v1/departments/*/children', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(13, 5, '启用禁用部门', 22, 23, 4, 'system:department:status', 1, 1, '/api/v1/departments/*/status', 2, 'PATCH', NULL, NULL, '2019-10-18 10:23:10', '2020-04-01 15:42:57'),
	(14, 4, '用户管理', 25, 48, 3, 'system:user', 1, 1, NULL, 1, NULL, NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(15, 14, '获取用户列表', 26, 27, 4, 'system:user:list', 1, 1, '/api/v1/users', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(16, 14, '新建用户', 28, 29, 4, 'system:user:add', 1, 1, '/api/v1/users', 2, 'POST', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(17, 14, '批量删除用户', 30, 31, 4, 'system:user:batchDelete', 1, 1, '/api/v1/users', 2, 'DELETE', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(18, 14, '获取用户详情', 32, 33, 4, 'system:user:detail', 1, 1, '/api/v1/users/*', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(19, 14, '更新用户', 34, 35, 4, 'system:user:update', 1, 1, '/api/v1/users/*', 2, 'PUT', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(20, 14, '删除用户', 36, 37, 4, 'system:user:delete', 1, 1, '/api/v1/users/*', 2, 'DELETE', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(21, 14, '重置用户密码', 38, 39, 4, 'system:user:pwd:reset', 1, 1, '/api/v1/users/*/password', 2, 'PATCH', NULL, NULL, '2020-03-29 10:27:40', '2020-04-01 15:42:57'),
	(22, 14, '修改用户密码', 40, 41, 4, 'system:user:pwd:update', 1, 1, '/api/v1/users/*/pwd', 2, 'PATCH', NULL, NULL, '2020-03-29 10:28:39', '2020-04-01 15:42:57'),
	(23, 14, '获取用户角色', 42, 43, 4, 'system:user:roles', 1, 1, '/api/v1/users/*/roles', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(24, 14, '赋予用户角色', 44, 45, 4, 'system:user:grant', 1, 1, '/api/v1/users/*/roles', 2, 'POST', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(25, 14, '启用禁用用户', 46, 47, 4, 'system:user:status', 1, 1, '/api/v1/users/*/status', 2, 'PATCH', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(26, 4, '角色管理', 49, 70, 3, 'system:role', 1, 1, NULL, 1, NULL, NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(27, 26, '获取角色树', 50, 51, 4, 'system:role:tree', 1, 1, '/api/v1/roles', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(28, 26, '新建角色', 52, 53, 4, 'system:role:add', 1, 1, '/api/v1/roles', 2, 'POST', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(29, 26, '移动角色', 54, 55, 4, 'system:role:move', 1, 1, '/api/v1/roles', 2, 'PUT', NULL, NULL, '2020-03-29 10:37:33', '2020-04-01 15:42:57'),
	(30, 26, '获取角色详情', 56, 57, 4, 'system:role:detail', 1, 1, '/api/v1/roles/*', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(31, 26, '更新角色', 58, 59, 4, 'system:role:update', 1, 1, '/api/v1/roles/*', 2, 'PUT', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(32, 26, '删除角色', 60, 61, 4, 'system:role:delete', 1, 1, '/api/v1/roles/*', 2, 'DELETE', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(33, 26, '获取子角色列表', 62, 63, 4, 'system:role:children', 1, 1, '/api/v1/roles/*/children', 2, 'GET', NULL, NULL, '2020-03-29 10:40:24', '2020-04-01 15:42:57'),
	(34, 26, '获取角色资源', 64, 65, 4, 'system:role:resources', 1, 1, '/api/v1/roles/*/resources', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(35, 26, '赋予角色资源', 66, 67, 4, 'system:role:grant', 1, 1, '/api/v1/roles/*/resources', 2, 'POST', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(36, 26, '启用禁用角色', 68, 69, 4, 'system:role:status', 1, 1, '/api/v1/roles/*/status', 2, 'PATCH', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(37, 4, '菜单管理', 71, 88, 3, 'system:menu', 1, 1, NULL, 1, NULL, NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(38, 37, '获取菜单树', 72, 73, 4, 'system:menu:tree', 1, 1, '/api/v1/resources', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(39, 37, '新建菜单', 74, 75, 4, 'system:menu:add', 1, 1, '/api/v1/resources', 2, 'POST', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(40, 37, '菜单移动', 76, 77, 4, 'system:menu:move', 1, 1, '/api/v1/resources', 2, 'PUT', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(41, 37, '获取菜单详情', 78, 79, 4, 'system:menu:detail', 1, 1, '/api/v1/resources/*', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(42, 37, '更新菜单', 80, 81, 4, 'system:menu:update', 1, 1, '/api/v1/resources/*', 2, 'PUT', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(43, 37, '删除菜单', 82, 83, 4, 'system:menu:delete', 1, 1, '/api/v1/resources/*', 2, 'DELETE', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(44, 37, '获取子菜单列表', 84, 85, 4, 'system:menu:children', 1, 1, '/api/v1/resources/*/children', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(45, 37, '启用禁用菜单', 86, 87, 4, 'system:menu:status', 1, 1, '/api/v1/resources/*/status', 2, 'PATCH', NULL, NULL, '2019-10-18 10:30:58', '2020-04-01 15:42:57'),
	(46, 4, '接口保护', 89, 104, 3, 'system:api', 1, 1, NULL, 1, NULL, NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(47, 46, '新建接口', 90, 91, 4, 'system:api:add', 1, 1, '/api/v1/resources', 2, 'POST', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(48, 46, '移动接口', 92, 93, 4, 'system:api:move', 1, 1, '/api/v1/resources', 2, 'PUT', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(49, 46, '获取接口详情', 94, 95, 4, 'system:api:detail', 1, 1, '/api/v1/resources/*', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(50, 46, '更新接口', 96, 97, 4, 'system:api:update', 1, 1, '/api/v1/resources/*', 2, 'PUT', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(51, 46, '删除接口', 98, 99, 4, 'system:api:delete', 1, 1, '/api/v1/resources/*', 2, 'DELETE', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(52, 46, '获取子接口列表', 100, 101, 4, 'system:api:children', 1, 1, '/api/v1/resources/*/children', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(53, 46, '启用禁用接口', 102, 103, 4, 'system:api:status', 1, 1, '/api/v1/resources/*/status', 2, 'PATCH', NULL, NULL, '2019-10-18 10:33:12', '2020-04-01 15:42:57'),
	(54, 4, '字典管理', 105, 120, 3, 'system:dictionary', 1, 1, NULL, 1, NULL, NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(55, 54, '获取字典列表', 106, 107, 4, 'system:dictionary:list', 1, 1, '/api/v1/dictionaries', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(56, 54, '新建字典', 108, 109, 4, 'system:dictionary:add', 1, 1, '/api/v1/dictionaries', 2, 'POST', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(57, 54, '批量删除字典', 110, 111, 4, 'system:dictionary:batchDelete', 1, 1, '/api/v1/dictionaries', 2, 'DELETE', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	(58, 54, '获取字典详情', 112, 113, 4, 'system:dictionary:detail', 1, 1, '/api/v1/dictionaries/*', 2, 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-04-01 15:42:57'),
	...
	(62, 4, '信息管理', 121, 142, 3, 'system:message', 1, 1, NULL, 1, NULL, NULL, NULL, '2020-03-28 12:52:20', '2020-04-01 15:42:57'),
	(63, 62, '获取信息列表', 122, 123, 4, 'system:message:list', 1, 1, '/api/v1/message', 2, 'GET', NULL, NULL, '2020-03-29 11:09:36', '2020-04-01 15:42:57'),
	(64, 62, '新建信息', 124, 125, 4, 'system:message:add', 1, 1, '/api/v1/message', 2, 'POST', NULL, NULL, '2020-03-29 11:10:31', '2020-04-01 15:42:57'),
	(65, 62, '批量发布信息', 126, 127, 4, 'system:message:batchPublish', 1, 1, '/api/v1/message', 2, 'PUT', NULL, NULL, '2020-03-29 11:12:49', '2020-04-01 15:42:57'),
	(66, 62, '批量删除信息', 128, 129, 4, 'system:message:batchDelete', 1, 1, '/api/v1/message', 2, 'DELETE', NULL, NULL, '2020-03-29 11:13:27', '2020-04-01 15:42:57'),
	(67, 62, '获取信息详情', 130, 131, 4, 'system:message:detail', 1, 1, '/api/v1/message/*', 2, 'GET', NULL, NULL, '2020-03-29 11:18:23', '2020-04-01 15:42:57'),
	(68, 62, '更新信息', 132, 133, 4, 'system:message:update', 1, 1, '/api/v1/message/*', 2, 'PUT', NULL, NULL, '2020-03-29 11:19:04', '2020-04-01 15:42:57'),
	(69, 62, '删除信息', 134, 135, 4, 'system:message:delete', 1, 1, '/api/v1/message/*', 2, 'DELETE', NULL, NULL, '2020-03-29 11:19:41', '2020-04-01 15:42:57'),
	(70, 62, '发布信息', 136, 137, 4, 'system:message:publish', 1, 1, '/api/v1/message/*/publish', 2, 'PATCH', NULL, NULL, '2020-03-29 11:20:39', '2020-04-01 15:42:57'),
	(71, 62, '启用禁用信息', 138, 139, 4, 'system:message:status', 1, 1, '/api/v1/message/*/status', 2, 'PATCH', NULL, NULL, '2020-03-29 11:21:37', '2020-04-01 15:42:57'),
	(72, 62, '定时发布信息', 140, 141, 4, 'system:message:timer', 1, 1, '/api/v1/message/timer', 2, 'POST', NULL, NULL, '2020-03-30 03:29:19', '2020-04-01 15:42:57');
...
INSERT INTO `sys_user` (`id`, `username`, `nickname`, `real_name`, `password`, `salt`, `status`, `avatar`, `email`, `phone`, `mobile`, `sex`, `profile`, `signature`, `address`, `last_login_time`, `create_time`, `update_time`) VALUES
	(1, 'admin', '管理员', 'hankaibo', '$2a$10$BQNgm4HovoDft9kj93gSgOnV0PNjDwSEEqTTt81Ghd5sgH1zAs5kO', '$2a$10$BQNgm4HovoDft9kj93gSgO', 1, 'E:/tmp/upload/images/d5034ec5-4938-4d68-98cf-9e8058f164e6.jpeg', 'hankaibo@mail.com', '+86-12345678', '+86-18612345678', NULL, '我是一条狗。', '胸无点墨，满腹牢骚', '丰台区翠林小区三里13号楼', NULL, '2019-10-03 00:43:06', '2020-08-14 02:27:50'),
