...
VALUES (1, NULL, '根', 1, 6, 1, 'ENABLED', 1, NULL, '2021-03-20 17:52:15', '2021-03-20 22:19:17'),
...
INSERT INTO `sys_dictionary` (`id`, `parent_id`, `name`, `code`, `value`, `status`, `sort`, `description`,
                              `create_time`, `update_time`)
VALUES (10, NULL, '性别', 'sex', '7', 'ENABLED', NULL, NULL, '2019-10-18 13:09:54', '2021-03-21 01:37:07'),
...
VALUES (27, 'test1', NULL, 'NOTIFICATION', '2020-09-08 15:52:52', NULL);
/*!40000 ALTER TABLE `sys_message_content`
    ENABLE KEYS */;
...
INSERT INTO `sys_message_receiver` (`id`, `send_id`, `receive_id`, `content_id`, `status`, `is_read`, `create_time`,
                                    `update_time`)
VALUES (1, 1, 1, 11, 'ENABLED', 0, '2020-06-10 16:08:53', NULL),
...
INSERT INTO `sys_message_sender` (`id`, `send_id`, `receive_id`, `content_id`, `status`, `is_publish`, `publish_time`,
                                  `create_time`, `update_time`)
VALUES (1, 1, 1, 11, 'ENABLED', 1, NULL, '2020-06-10 16:08:53', NULL),
...
VALUES (1, NULL, '菜单', 1, 148, 1, 'menuTree', 'ENABLED', 1, NULL, 'MENU', NULL, NULL, NULL, '2019-10-07 01:30:52',
        '2020-12-06 22:51:16'),
       (2, 1, '首页', 2, 5, 2, 'home', 'ENABLED', 1, NULL, 'MENU', NULL, NULL, NULL, '2019-10-07 01:30:52',
        '2021-03-21 01:36:31'),
       (3, 2, '获取当前登录用户信息', 3, 4, 3, 'system:user:info', 'DISABLED', 1, '/api/v1/users/info', 'API', 'GET', NULL, NULL,
        '2019-10-07 01:30:52', '2021-03-21 01:36:31'),
       (4, 1, '系统配置', 32, 147, 2, 'system', 'ENABLED', 1, NULL, 'MENU', NULL, NULL, NULL, '2019-10-07 01:30:52',
        '2020-12-06 22:51:16'),
       (5, 4, '部门管理', 33, 50, 3, 'system:department', 'ENABLED', 1, NULL, 'MENU', NULL, NULL, NULL,
        '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (6, 5, '获取部门树', 34, 35, 4, 'system:department:tree', 'ENABLED', 1, '/api/v1/departments', 'API', 'GET', NULL,
        NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (7, 5, '新建部门', 36, 37, 4, 'system:department:add', 'ENABLED', 1, '/api/v1/departments', 'API', 'POST', NULL,
        NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (8, 5, '移动部门', 38, 39, 4, 'system:department:move', 'ENABLED', 1, '/api/v1/departments', 'API', 'PUT', NULL,
        NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (9, 5, '获取部门详情', 40, 41, 4, 'system:department:detail', 'ENABLED', 1, '/api/v1/departments/*', 'API', 'GET',
        NULL, NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (10, 5, '更新部门', 42, 43, 4, 'system:department:update', 'ENABLED', 1, '/api/v1/departments/*', 'API', 'PUT', NULL,
        NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (11, 5, '删除部门', 44, 45, 4, 'system:department:delete', 'ENABLED', 1, '/api/v1/departments/*', 'API', 'DELETE',
        NULL, NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (12, 5, '获取子部门列表', 46, 47, 4, 'system:department:children', 'ENABLED', 1, '/api/v1/departments/*/children',
        'API', 'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (13, 5, '启用禁用部门', 48, 49, 4, 'system:department:status', 'ENABLED', 1, '/api/v1/departments/*/status', 'API',
        'PATCH', NULL, NULL, '2019-10-18 10:23:10', '2020-12-06 22:51:16'),
       (14, 4, '用户管理', 51, 74, 3, 'system:user', 'ENABLED', 1, NULL, 'MENU', NULL, NULL, NULL, '2019-10-07 01:30:52',
        '2020-12-06 22:51:16'),
       (15, 14, '获取用户列表', 52, 53, 4, 'system:user:list', 'ENABLED', 1, '/api/v1/users', 'API', 'GET', NULL, NULL,
        '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (16, 14, '新建用户', 54, 55, 4, 'system:user:add', 'ENABLED', 1, '/api/v1/users', 'API', 'POST', NULL, NULL,
        '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (17, 14, '批量删除用户', 56, 57, 4, 'system:user:batchDelete', 'ENABLED', 1, '/api/v1/users', 'API', 'DELETE', NULL,
        NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (18, 14, '获取用户详情', 58, 59, 4, 'system:user:detail', 'ENABLED', 1, '/api/v1/users/*', 'API', 'GET', NULL, NULL,
        '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (19, 14, '更新用户', 60, 61, 4, 'system:user:update', 'ENABLED', 1, '/api/v1/users/*', 'API', 'PUT', NULL, NULL,
        '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (20, 14, '删除用户', 62, 63, 4, 'system:user:delete', 'ENABLED', 1, '/api/v1/users/*', 'API', 'DELETE', NULL, NULL,
        '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (21, 14, '重置用户密码', 64, 65, 4, 'system:user:pwd:reset', 'ENABLED', 1, '/api/v1/users/*/password', 'API', 'PATCH',
        NULL, NULL, '2020-03-29 10:27:40', '2020-12-06 22:51:16'),
       (22, 14, '修改用户密码', 66, 67, 4, 'system:user:pwd:update', 'ENABLED', 1, '/api/v1/users/*/pwd', 'API', 'PATCH',
        NULL, NULL, '2020-03-29 10:28:39', '2020-12-06 22:51:16'),
       (23, 14, '获取用户角色', 68, 69, 4, 'system:user:roles', 'ENABLED', 1, '/api/v1/users/*/roles', 'API', 'GET', NULL,
        NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (24, 14, '赋予用户角色', 70, 71, 4, 'system:user:grant', 'ENABLED', 1, '/api/v1/users/*/roles', 'API', 'POST', NULL,
        NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (25, 14, '启用禁用用户', 72, 73, 4, 'system:user:status', 'ENABLED', 1, '/api/v1/users/*/status', 'API', 'PATCH', NULL,
        NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (26, 4, '角色管理', 75, 96, 3, 'system:role', 'ENABLED', 1, NULL, 'MENU', NULL, NULL, NULL, '2019-10-07 01:30:52',
        '2020-12-06 22:51:16'),
       (27, 26, '获取角色树', 76, 77, 4, 'system:role:tree', 'ENABLED', 1, '/api/v1/roles', 'API', 'GET', NULL, NULL,
        '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (28, 26, '新建角色', 78, 79, 4, 'system:role:add', 'ENABLED', 1, '/api/v1/roles', 'API', 'POST', NULL, NULL,
        '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (29, 26, '移动角色', 80, 81, 4, 'system:role:move', 'ENABLED', 1, '/api/v1/roles', 'API', 'PUT', NULL, NULL,
        '2020-03-29 10:37:33', '2020-12-06 22:51:16'),
       (30, 26, '获取角色详情', 82, 83, 4, 'system:role:detail', 'ENABLED', 1, '/api/v1/roles/*', 'API', 'GET', NULL, NULL,
        '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (31, 26, '更新角色', 84, 85, 4, 'system:role:update', 'ENABLED', 1, '/api/v1/roles/*', 'API', 'PUT', NULL, NULL,
        '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (32, 26, '删除角色', 86, 87, 4, 'system:role:delete', 'ENABLED', 1, '/api/v1/roles/*', 'API', 'DELETE', NULL, NULL,
        '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (33, 26, '获取子角色列表', 88, 89, 4, 'system:role:children', 'ENABLED', 1, '/api/v1/roles/*/children', 'API', 'GET',
        NULL, NULL, '2020-03-29 10:40:24', '2020-12-06 22:51:16'),
       (34, 26, '获取角色资源', 90, 91, 4, 'system:role:resources', 'ENABLED', 1, '/api/v1/roles/*/resources', 'API', 'GET',
        NULL, NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (35, 26, '赋予角色资源', 92, 93, 4, 'system:role:grant', 'ENABLED', 1, '/api/v1/roles/*/resources', 'API', 'POST',
        NULL, NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (36, 26, '启用禁用角色', 94, 95, 4, 'system:role:status', 'ENABLED', 1, '/api/v1/roles/*/status', 'API', 'PATCH', NULL,
        NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (37, 4, '菜单管理', 97, 114, 3, 'system:menu', 'ENABLED', 1, NULL, 'MENU', NULL, NULL, NULL, '2019-10-07 01:30:52',
        '2020-12-06 22:51:16'),
       (38, 37, '获取菜单树', 98, 99, 4, 'system:menu:tree', 'ENABLED', 1, '/api/v1/resources', 'API', 'GET', NULL, NULL,
        '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (39, 37, '新建菜单', 100, 101, 4, 'system:menu:add', 'ENABLED', 1, '/api/v1/resources', 'API', 'POST', NULL, NULL,
        '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (40, 37, '菜单移动', 102, 103, 4, 'system:menu:move', 'ENABLED', 1, '/api/v1/resources', 'API', 'PUT', NULL, NULL,
        '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (41, 37, '获取菜单详情', 104, 105, 4, 'system:menu:detail', 'ENABLED', 1, '/api/v1/resources/*', 'API', 'GET', NULL,
        NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (42, 37, '更新菜单', 106, 107, 4, 'system:menu:update', 'ENABLED', 1, '/api/v1/resources/*', 'API', 'PUT', NULL,
        NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (43, 37, '删除菜单', 108, 109, 4, 'system:menu:delete', 'ENABLED', 1, '/api/v1/resources/*', 'API', 'DELETE', NULL,
        NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (44, 37, '获取子菜单列表', 110, 111, 4, 'system:menu:children', 'ENABLED', 1, '/api/v1/resources/*/children', 'API',
        'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (45, 37, '启用禁用菜单', 112, 113, 4, 'system:menu:status', 'ENABLED', 1, '/api/v1/resources/*/status', 'API', 'PATCH',
        NULL, NULL, '2019-10-18 10:30:58', '2020-12-06 22:51:16'),
       (46, 4, '接口保护', 115, 130, 3, 'system:api', 'ENABLED', 1, NULL, 'MENU', NULL, NULL, NULL, '2019-10-07 01:30:52',
        '2020-12-06 22:51:16'),
       (47, 46, '新建接口', 116, 117, 4, 'system:api:add', 'ENABLED', 1, '/api/v1/resources', 'API', 'POST', NULL, NULL,
        '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (48, 46, '移动接口', 118, 119, 4, 'system:api:move', 'ENABLED', 1, '/api/v1/resources', 'API', 'PUT', NULL, NULL,
        '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (49, 46, '获取接口详情', 120, 121, 4, 'system:api:detail', 'ENABLED', 1, '/api/v1/resources/*', 'API', 'GET', NULL,
        NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (50, 46, '更新接口', 122, 123, 4, 'system:api:update', 'ENABLED', 1, '/api/v1/resources/*', 'API', 'PUT', NULL, NULL,
        '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (51, 46, '删除接口', 124, 125, 4, 'system:api:delete', 'ENABLED', 1, '/api/v1/resources/*', 'API', 'DELETE', NULL,
        NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (52, 46, '获取子接口列表', 126, 127, 4, 'system:api:children', 'ENABLED', 1, '/api/v1/resources/*/children', 'API',
        'GET', NULL, NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (53, 46, '启用禁用接口', 128, 129, 4, 'system:api:status', 'ENABLED', 1, '/api/v1/resources/*/status', 'API', 'PATCH',
        NULL, NULL, '2019-10-18 10:33:12', '2020-12-06 22:51:16'),
       (54, 4, '字典管理', 131, 146, 3, 'system:dictionary', 'ENABLED', 1, NULL, 'MENU', NULL, NULL, NULL,
        '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (55, 54, '获取字典列表', 132, 133, 4, 'system:dictionary:list', 'ENABLED', 1, '/api/v1/dictionaries', 'API', 'GET',
        NULL, NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (56, 54, '新建字典', 134, 135, 4, 'system:dictionary:add', 'ENABLED', 1, '/api/v1/dictionaries', 'API', 'POST', NULL,
        NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (57, 54, '批量删除字典', 136, 137, 4, 'system:dictionary:batchDelete', 'ENABLED', 1, '/api/v1/dictionaries', 'API',
        'DELETE', NULL, NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (58, 54, '获取字典详情', 138, 139, 4, 'system:dictionary:detail', 'ENABLED', 1, '/api/v1/dictionaries/*', 'API', 'GET',
        NULL, NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (59, 54, '更新字典', 140, 141, 4, 'system:dictionary:update', 'ENABLED', 1, '/api/v1/dictionaries/*', 'API', 'PUT',
        NULL, NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (60, 54, '删除字典', 142, 143, 4, 'system:dictionary:delete', 'ENABLED', 1, '/api/v1/dictionaries/*', 'API',
        'DELETE', NULL, NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (61, 54, '启用禁用字典', 144, 145, 4, 'system:dictionary:status', 'ENABLED', 1, '/api/v1/dictionaries/*/status', 'API',
        'PUT', NULL, NULL, '2019-10-07 01:30:52', '2020-12-06 22:51:16'),
       (63, 76, '获取信息列表', 8, 9, 4, 'system:message:list', 'DISABLED', 1, '/api/v1/messages', 'API', 'GET', NULL, NULL,
        '2020-03-29 11:09:36', '2021-03-21 01:36:42'),
       (64, 76, '新建信息', 10, 11, 4, 'system:message:add', 'DISABLED', 1, '/api/v1/messages', 'API', 'POST', NULL, NULL,
        '2020-03-29 11:10:31', '2021-03-21 01:36:42'),
       (65, 76, '批量发布信息', 26, 27, 4, 'system:message:batchPublish', 'DISABLED', 1, '/api/v1/messages', 'API', 'PUT',
        NULL, NULL, '2020-03-29 11:12:49', '2021-03-21 01:36:42'),
       (66, 76, '批量删除信息', 14, 15, 4, 'system:message:batchDelete', 'DISABLED', 1, '/api/v1/messages', 'API', 'DELETE',
        NULL, NULL, '2020-03-29 11:13:27', '2021-03-21 01:36:42'),
       (67, 76, '获取信息详情', 12, 13, 4, 'system:message:detail', 'DISABLED', 1, '/api/v1/messages/*', 'API', 'GET', NULL,
        NULL, '2020-03-29 11:18:23', '2021-03-21 01:36:42'),
       (68, 76, '更新信息', 16, 17, 4, 'system:message:update', 'DISABLED', 1, '/api/v1/messages/*', 'API', 'PUT', NULL,
        NULL, '2020-03-29 11:19:04', '2021-03-21 01:36:42'),
       (69, 76, '删除信息', 18, 19, 4, 'system:message:delete', 'DISABLED', 1, '/api/v1/messages/*', 'API', 'DELETE', NULL,
        NULL, '2020-03-29 11:19:41', '2021-03-21 01:36:42'),
       (70, 76, '发布信息', 20, 21, 4, 'system:message:publish', 'DISABLED', 1, '/api/v1/messages/*/publish', 'API',
        'PATCH', NULL, NULL, '2020-03-29 11:20:39', '2021-03-21 01:36:42'),
       (71, 76, '启用禁用信息', 22, 23, 4, 'system:message:status', 'DISABLED', 1, '/api/v1/messages/*/status', 'API',
        'PATCH', NULL, NULL, '2020-03-29 11:21:37', '2021-03-21 01:36:42'),
       (72, 76, '定时发布信息', 24, 25, 4, 'system:message:timer', 'DISABLED', 1, '/api/v1/messages/timer', 'API', 'POST',
        NULL, NULL, '2020-03-30 03:29:19', '2021-03-21 01:36:42'),
       (73, 1, '个人页', 6, 31, 2, 'account', 'ENABLED', 1, NULL, 'MENU', NULL, NULL, NULL, '2020-08-27 15:55:07',
        '2021-03-21 01:36:42'),
       (76, 73, '个人中心', 7, 28, 3, 'account:center', 'DISABLED', 1, NULL, 'MENU', NULL, NULL, NULL,
        '2020-08-27 16:05:34', '2021-03-21 01:36:42'),
       (77, 73, '个人设置', 29, 30, 3, 'account:setting', 'DISABLED', 1, NULL, 'MENU', NULL, NULL, NULL,
        '2020-08-27 16:05:50', '2021-03-21 01:36:42');
/*!40000 ALTER TABLE `sys_resource`
    ENABLE KEYS */;
...
INSERT INTO `sys_role` (`id`, `code`, `parent_id`, `name`, `lft`, `rgt`, `level`, `status`, `is_update`, `description`,
                        `create_time`, `update_time`)
VALUES (1, 'Administration', NULL, '管理员', 1, 10, 1, 'ENABLED', 1, '系统管理员，拥有系统所有资源的管理权限。', '2019-10-07 01:16:01',
        '2020-12-06 22:30:31'),
       (37, 'user1', 1, '普通角色', 2, 3, 2, 'ENABLED', 1, '只拥有个人相关的权限。', '2020-11-03 00:35:34', '2021-03-21 01:26:54'),
       (38, 'user2', 1, '部门管理员', 4, 5, 2, 'ENABLED', 1, '拥有部门与用户管理相关的所有权限。', '2020-11-03 00:35:41',
        '2020-12-12 14:36:30'),
       (39, 'user3', 1, '审查角色', 6, 7, 2, 'ENABLED', 1, '只拥有查看权限。', '2020-11-03 00:35:48', '2020-12-12 14:38:51'),
       (40, 'user4', 1, '测试角色', 8, 9, 2, 'ENABLED', 1, '测试只拥有用户权限没有部门权限的情况。', '2020-11-03 00:35:56',
        '2020-12-12 14:50:49');
/*!40000 ALTER TABLE `sys_role`
    ENABLE KEYS */;
...
VALUES (1, 'admin', '管理员', 'hankaibo', '$2a$10$BQNgm4HovoDft9kj93gSgOnV0PNjDwSEEqTTt81Ghd5sgH1zAs5kO',
        '$2a$10$BQNgm4HovoDft9kj93gSgO', 'ENABLED', 'E:/tmp/upload/images/b74f87f7-f1dc-4b59-959f-315bdbd8dc58.jpeg',
        'hankaibo@mail.com', '+86-12345678', '+86-18612345678', NULL, '我是一条狗。', '胸无点墨，满腹牢骚', '东城区1号', NULL,
        '2019-10-03 00:43:06', '2021-03-21 01:26:38'),
       (32, 'hankaibo', NULL, NULL, '$2a$10$BCLF4kcbYfxKftlnWO.0KuVLCMtrnajV4nCPqD05hJWaxKqbf/37i',
        '$2a$10$BCLF4kcbYfxKftlnWO.0Ku', 'ENABLED', 'E:/tmp/upload/images/e5f122e5-c0a5-4fd1-a2de-fcca5b7b4ad7.jpg',
        NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-09-07 14:16:37', '2020-09-08 00:24:48'),
       (39, 'hp', NULL, NULL, '$2a$10$lKjqhVHXx/E/ayrnHjd2m.IzcL10xA4RHGb2Do.89FTpcqt3Ti39e',
        '$2a$10$lKjqhVHXx/E/ayrnHjd2m.', 'ENABLED', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        '2020-12-12 14:39:37', '2021-03-20 23:52:06');
/*!40000 ALTER TABLE `sys_user`
    ENABLE KEYS */;
